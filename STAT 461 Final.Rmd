...
- Given the number of awards, does failing the Bechdel test lead to a higher IMBD score?
- Given the Bechdel test score, does winning more awards lead to a higher IMBD score?
...
All of this points to useing ANOVA methods to answer our research questions. For 
...
factors are not attributes of the movies themselves, just outcomes caused by the
