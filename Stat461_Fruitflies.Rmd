...
In general, a group of fruit flies will have a larger longevity at a rate of 
57.90 times as many days per fly; this is our estimate for baseline performance (\(\widehat{\mu_{\bullet\bullet}}\)). We can also see the factor level (treatment) effects (\(\widehat{\alpha_i}\)) estimates. For the null treatment, male fruit flies will accumulate an addition 4.06 days per fly. For the pregnant treatments, male fruit flies will accumulate an additional 10.70 days per fly if there is only 1 other female fly present whereas if there are 8 female flies, they lose approximately 0.98 days per fly. As for the virgin treatments, male fruit flies will accumulate an additional 7.30 days per fly if there is only 1 other female fruit fly present whereas if there are 8, they lost about 21.19 days per fly. 

This suggests that when male fruit flies are put in a room with eight virgin fruit flies, they do much worse than the baseline performance. Looking at these numbers however, it might also suggest that putting them in a room with eight other fruit flies decreases their longevity, since they both do worse than the baseline performance. It seems as though the treatment of eight virgin flies performs much worse than the rest, so this is something that can be looked into during the post-hoc analysis. 
